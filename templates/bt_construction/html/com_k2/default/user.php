...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<?php if (($this->params->get('userName') || $this->params->get('userDescription') || (($this->params->get('userURL') && isset($this->user->profile->url) && $this->user->profile->url) || $this->params->get('userEmail')))): ?>
			<div class="userBlockInfo">
				<?php if ($this->params->get('userName')): ?>
				<h2 class="userName"><span><?php echo $this->user->name; ?></span></h2>
				<?php endif; ?>
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<div class="userItemHeader">			
			  ...
			  <?php endif; ?>
				...
				<?php if(($this->params->get('userItemDateCreated')) || ($this->params->get('userItemCommentsAnchor') && ( ($this->params->get('comments') == '2' && !$this->user->guest) || ($this->params->get('comments') == '1')) )): ?>
					<div class="k2ItemInfo">	
						<?php if($this->params->get('userItemDateCreated')): ?>
						<div class="userItemDateCreated">
							<?php echo JHTML::_('date', $item->created , JText::_('BT_CONSTRUCTION_DATE_ARTICLE_CREATED')); ?>
						</div>
						<?php endif; ?>
