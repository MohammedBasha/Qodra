...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
	  ...
	  <?php endif; ?>
		...
		<?php if(($this->item->params->get('catItemAuthor')) || ($this->item->params->get('catItemDateCreated')) || ($this->item->params->get('catItemCommentsAnchor') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) )): ?>	
			<div class="k2ItemInfo">
				<?php if($this->item->params->get('catItemAuthor')): ?>
				<div class="catItemAuthor">
					<span><?php echo JText::_('BT_CONSTRUCTION_ARTICLE_CREATED_BY'); ?></span>
				...
				<div class="catItemDateCreated">
					<?php echo JHTML::_('date', $this->item->created , JText::_('BT_CONSTRUCTION_DATE_ARTICLE_CREATED')); ?>
				</div>
				<?php endif; ?>
  ...
  <div class="catItemBody">
	  ...
	  <div class="catItemIntroText">
	  	<?php echo K2HelperUtilities::wordLimit($this->item->introtext, 25); ?>
	  </div>
	  <?php endif; ?>
