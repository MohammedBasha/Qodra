	...
	<table class="category table table-striped table-bordered table-hover<?php echo $tableClass; ?>">
		...
		<thead>
			<tr>
				...
				<?php endif; ?>
				<th scope="col" id="applying-deadline-title">
					Applying Deadline
				</th>
			</tr>
		</thead>
		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<?php
				...
				//foreach($this->items[$i]->jcfields as $field) {
				    //$myCustomFields[$field->title] = $field->value;
				    // RECOVER CUSTOM FILED NAME
				    //if (isset($myCustomFields[$field->title]) and !empty($myCustomFields[$field->title])) : ?>
				        <td headers="applying-deadline-title">
				        	<?php 
				        	if (isset($this->items[$i]->jcfields[3]->value) and !empty($this->items[$i]->jcfields[3]->value)) :
				        	echo $this->items[$i]->jcfields[3]->value;
							endif;
							if (isset($this->items[$i]->jcfields[5]->value) and !empty($this->items[$i]->jcfields[5]->value)) :
				        	echo $this->items[$i]->jcfields[5]->value;
							endif;
				        	?>
				        </td>    
		    <?php //endif;
