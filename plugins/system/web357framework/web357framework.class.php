...
class Web357FrameworkHelperClass
{
	...
	public function apikeyChecker()
	{
		if (empty($this->apikey) || $this->apikey == '')
		{
			...
			$api_key_missed_msg = JText::_('<span class="icon-key" aria-hidden="true"></span> In order to update commercial Web357 extensions you have to add your Web357 API Key in the <a href="index.php?option=com_plugins&view=plugins&filter[search]=Web357%20Framework" title="Web357 Framework plugin settings"><strong>Web357 Framework plugin</strong></a>. You can find the API Key in your <a href="https://www.web357.com/payment-history" target="_blank" title="Web357 Account Settings"><strong>Account settings at Web357.com</strong></a>.');
