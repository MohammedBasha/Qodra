...
class JFormFieldinfo extends JFormField {
	...
	{	
		...
		$web357_releases_json_url = 'http://api.web357.com/web357api/get/web357/get-web357-extension-latest-version/?extension='.urlencode($extension_name);
		
		$web357_releases_json = '';
		if ($this->url_exists($web357_releases_json_url))
		{
		...
		{
			if ($web357_releases_json->extension == $extension_name)
			{
		...
		if (!empty($latest_version) && !empty($latest_creationDate))
		{
			...
			else
			{
				...
				&nbsp;&nbsp;&nbsp;'.JText::_('W357FRM_OR').'&nbsp;&nbsp;&nbsp;
				<a href="https://www.web357.com/my-account/downloads/" target="_blank">'.JText::_('W357FRM_GO_TO_DOWNLOAD_AREA').'</a>
				</div>';
			}
		}
		else
